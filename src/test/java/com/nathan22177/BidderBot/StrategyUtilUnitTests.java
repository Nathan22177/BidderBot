...
public class StrategyUtilUnitTests {
    ...
    public void allBidsMedianTest() {
        ...
        // Median should be 7
        LinkedList<Pair<Integer,Integer>> mockHistory = new LinkedList<>();
        mockHistory.add(new Pair<>(5, 17));
        mockHistory.add(new Pair<>(3, 9));
        mockHistory.add(new Pair<>(14, 2));
        mockHistory.add(new Pair<>(2, 5));
        mockHistory.add(new Pair<>(9, 3));
